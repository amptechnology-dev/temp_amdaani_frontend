// components/BottomSheet/CustomerDetailBottomSheet.jsx
...
const CustomerDetailBottomSheet = forwardRef(
  ({ customerData = {}, onSave }, ref) => {
    ...
    const validateForm = async () => {
      try {
        ...
        setErrors(newErrors);
        setTouched(
          Object.keys(newErrors).reduce((a, k) => ({ ...a, [k]: true }), {}),
        );
        return false;
      }
    };
...
export default CustomerDetailBottomSheet;
