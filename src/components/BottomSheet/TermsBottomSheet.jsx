        ...
        <View style={styles.container}>
          ...
          <View style={styles.section}>
            ...
            <Text variant="bodyMedium" style={styles.paragraph}>
              Welcome to our billing and invoicing application ("App"). By
          ...
          <View style={styles.section}>
            ...
            <Text variant="bodyMedium" style={styles.paragraph}>
              Our App provides billing, invoicing, and business management
              tools. You agree to use these services only for lawful business
              purposes and in accordance with applicable laws and regulations.
            </Text>
          </View>
          ...
          <View style={styles.section}>
            ...
            <Text variant="bodyMedium" style={styles.paragraph}>
              We take your privacy seriously. All data collected through the App
              is handled in accordance with our Privacy Policy. By using the
              App, you consent to:
            </Text>
            <View style={styles.bulletList}>
              <Text variant="bodyMedium" style={styles.bulletPoint}>
          ...
          <View style={styles.section}>
            ...
            <Text variant="bodyMedium" style={styles.paragraph}>
              ...
              provide accurate payment information and authorize us to charge
              the applicable fees. Subscriptions automatically renew unless
          ...
          <View style={styles.section}>
            ...
            <Text variant="bodyMedium" style={styles.paragraph}>
              ...
              any time through the App settings. Upon termination, your access
              to the App will cease immediately.
            </Text>
          </View>
