...
const DueInvoiceDetails = () => {
  ...
  const fetchDueDetails = async () => {
    try {
      const res = await api.get(`/customer/due/${id}`);
  ...
  if (loading) {
    return (
      ...
      >
        <Navbar title="Due Invoice Details" />
  ...
  return (
    ...
    >
      <Navbar
        title={`${customer.name ? `${customer.name}'s Due Details` : 'Due Details'
          }`}
      />
      <ScrollView
                    ...
                    <Text
                      onPress={() =>
                        navigation.navigate('InvoiceDetail', {
                          invoiceId: invoice._id, // you can pass invoiceId
