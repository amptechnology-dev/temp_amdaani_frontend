...
const validationSchema = Yup.object().shape({
  ...
  mobile: Yup.string()
    ...
    .test(
      'mobile-or-landline',
      'Enter a valid Indian mobile or landline number',
      value => {
  ...
  const handleSubmit = async (values, { setSubmitting, resetForm }) => {
    ...
    try {
      ...
      if (isUpdate) {
        ...
        const id =
          existingVendor?.id ?? existingVendor?._id ?? existingVendor?._Id;
                ...
                >
                  <View style={styles.form}>
                    ...
                    <TextInput
                      ...
                      value={values.mobile}
                      onChangeText={text => {
                        // allow digits and hyphens only, max 12 chars
                        const cleaned = text
                          .replace(/[^\d-]/g, '')
                          .slice(0, 12);
                    ...
                    <TextInput
                      ...
                      onChangeText={text =>
                        setFieldValue('postalCode', text.replace(/\D/g, ''))
                      }
