...
const RegisterSimpleScreen = () => {
  ...
  const handleSubmitRegister = async values => {
    ...
    try {
      ...
      formData.append('userData[email]', values.email); // ✅ send email
      formData.append('storeData[name]', values.businessName);
      formData.append('storeData[type]', values.businessType);
      formData.append('storeData[email]', values.email); // ✅ send email to store too
            ...
            <>
              ...
              >
                ...
                <View style={styles.topHeader}>
                  ...
                  <Text variant="bodyMedium" style={styles.subtitle}>
                    Set up your business profile — fast, secure and
                    professional.
                  </Text>
                </View>
                ...
                >
                  <Card.Content>
                    ...
                    {/* ✅ Email — required */}
                    <TextInput
                      label={<FormLabel required>Email Address</FormLabel>}
                      value={values.email}
                    ...
                    <TextInput
                      ...
                      onChangeText={text =>
                        setFieldValue('address.pincode', text)
                      }
                          ...
                          style={[
                            {
                              ...
                              borderRadius: 4,
                              borderWidth: 2,
                              borderColor: values.hasGSTIN
                                ? theme.colors.primary
                                : '#666',
                              backgroundColor: values.hasGSTIN
                                ? theme.colors.primary
                                : 'transparent',
                              alignItems: 'center',
              ...
              <BusinessTypeSelectorBottomSheet
                ...
                onBusinessSelect={item => {
                  setFieldValue('businessType', item.label);
                }}
                selectedBusiness={
