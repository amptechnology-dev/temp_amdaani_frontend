              ...
              <View style={styles.detailsSection}>
                ...
                <Text variant="bodySmall" style={styles.dateText}>
                  {formatTransactionDate(
                    isPaid ? transaction.paidAt : transaction.createdAt,
                  )}
                </Text>
              </View>
            </View>
          ...
          {isFailed && transaction.notes && (
            <>
              ...
              <View style={styles.failedNote}>
                ...
                <Text
                  variant="bodySmall"
                  style={[styles.noteText, { color: statusConfig.color }]}
                >
                  {transaction.notes}
                </Text>
              </View>
        ...
        >
          <Chip
            ...
            style={[
              ...
              {
                backgroundColor:
                  statusFilter === 'all' ? '#3B82F6' : theme.colors.surface,
              },
            ]}
            textStyle={[
          ...
          <Chip
            ...
            style={[
              ...
              {
                backgroundColor:
                  statusFilter === 'success' ? '#D1FAE5' : theme.colors.surface,
              },
            ]}
            textStyle={[
              styles.filterChipText,
          ...
          <Chip
            ...
            style={[
              ...
              {
                backgroundColor:
                  statusFilter === 'pending' ? '#FEF3C7' : theme.colors.surface,
              },
            ]}
            textStyle={[
              styles.filterChipText,
          ...
          <Chip
            ...
            style={[
              ...
              {
                backgroundColor:
                  statusFilter === 'failed' ? '#FEE2E2' : theme.colors.surface,
              },
            ]}
            textStyle={[
              styles.filterChipText,
